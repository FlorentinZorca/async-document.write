...
c())},r=function(){var a;0<b.length?(d("Dequeuing"),c=a=b.shift(),s(a,function(){0<b.length?(d(a.hookNode.id+" done. Dequeue next one."),p(r,100)):(d(a.hookNode.id+" done. It was the last queue item."),c=null)})):d("Dequeue from empty queue.")},e={write:function(){var a,b,f;if(arguments.length){h++;f=Array.prototype.slice.call(arguments).join("");a=document.getElementsByTagName("script");0<a.length&&(b=a[a.length-1]);a=b.parentNode;var e=c?c.scriptNode?c.scriptNode:c.hookNode:null;if(!b||e===b)q(f);
else{var e="hook-"+m++,l=document.createElement("span");l.id=e;a.appendChild(l);k({hookNode:l,scriptNode:b,contentType:"html",content:f});d(" <- Queued write to "+e+": "+f)}}},applyWrite:function(){p(r,100)},enableLogging:function(){n=!0}};if(window.console){if(!window.console.log)console.log=function(){}}else window.console={log:function(){}};document.write=e.write;document.applyWrite=e.applyWrite;window.asyncWrite=e;"function"===typeof define&&define.amd&&define("async-document.write",function(){return e});
return e})();
